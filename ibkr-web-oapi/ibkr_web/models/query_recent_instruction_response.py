...
T = TypeVar("T", bound="QueryRecentInstructionResponse")


@_attrs_define
class QueryRecentInstructionResponse:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        query_recent_instruction_response = cls(
            status=status,
            instruction_set_id=instruction_set_id,
            instruction_result=instruction_result,
        )

        query_recent_instruction_response.additional_properties = d
        return query_recent_instruction_response
