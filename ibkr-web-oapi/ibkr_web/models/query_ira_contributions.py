...
T = TypeVar("T", bound="QueryIRAContributions")


@_attrs_define
class QueryIRAContributions:
    """
    Attributes:
        client_instruction_id (float):  Example: 1012983.
        account_id (str):  Example: U68903.
        year (str):  Example: 2003.
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        query_ira_contributions = cls(
            client_instruction_id=client_instruction_id,
            account_id=account_id,
            year=year,
        )

        query_ira_contributions.additional_properties = d
        return query_ira_contributions
