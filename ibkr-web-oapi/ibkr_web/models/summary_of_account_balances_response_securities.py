...
T = TypeVar("T", bound="SummaryOfAccountBalancesResponseSecurities")


@_attrs_define
class SummaryOfAccountBalancesResponseSecurities:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        summary_of_account_balances_response_securities = cls(
        ...
        summary_of_account_balances_response_securities.additional_properties = d
        return summary_of_account_balances_response_securities
