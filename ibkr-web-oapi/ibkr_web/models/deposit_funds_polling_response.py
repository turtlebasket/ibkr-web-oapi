...
T = TypeVar("T", bound="DepositFundsPollingResponse")


@_attrs_define
class DepositFundsPollingResponse:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        deposit_funds_polling_response = cls(
            status=status,
            instruction_set_id=instruction_set_id,
            instruction_result=instruction_result,
        )

        deposit_funds_polling_response.additional_properties = d
        return deposit_funds_polling_response
