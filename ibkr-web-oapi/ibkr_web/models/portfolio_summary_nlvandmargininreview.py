...
T = TypeVar("T", bound="PortfolioSummaryNlvandmargininreview")


@_attrs_define
class PortfolioSummaryNlvandmargininreview:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_nlvandmargininreview = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_nlvandmargininreview.additional_properties = d
        return portfolio_summary_nlvandmargininreview
