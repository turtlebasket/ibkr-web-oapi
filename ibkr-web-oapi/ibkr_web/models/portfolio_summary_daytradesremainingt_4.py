...
T = TypeVar("T", bound="PortfolioSummaryDaytradesremainingt4")


@_attrs_define
class PortfolioSummaryDaytradesremainingt4:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_daytradesremainingt_4 = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_daytradesremainingt_4.additional_properties = d
        return portfolio_summary_daytradesremainingt_4
