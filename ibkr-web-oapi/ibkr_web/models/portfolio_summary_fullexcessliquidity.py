...
T = TypeVar("T", bound="PortfolioSummaryFullexcessliquidity")


@_attrs_define
class PortfolioSummaryFullexcessliquidity:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_fullexcessliquidity = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_fullexcessliquidity.additional_properties = d
        return portfolio_summary_fullexcessliquidity
