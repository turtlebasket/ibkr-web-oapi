...
T = TypeVar("T", bound="PortfolioSummaryAccrueddividend")


@_attrs_define
class PortfolioSummaryAccrueddividend:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_accrueddividend = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_accrueddividend.additional_properties = d
        return portfolio_summary_accrueddividend
