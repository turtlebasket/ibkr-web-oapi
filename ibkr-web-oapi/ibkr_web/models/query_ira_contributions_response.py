...
T = TypeVar("T", bound="QueryIRAContributionsResponse")


@_attrs_define
class QueryIRAContributionsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        query_ira_contributions_response = cls(
            status=status,
            instruction_set_id=instruction_set_id,
            instruction_result=instruction_result,
        )

        query_ira_contributions_response.additional_properties = d
        return query_ira_contributions_response
