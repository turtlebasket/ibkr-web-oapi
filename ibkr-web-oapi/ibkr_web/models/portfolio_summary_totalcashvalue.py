...
T = TypeVar("T", bound="PortfolioSummaryTotalcashvalue")


@_attrs_define
class PortfolioSummaryTotalcashvalue:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_totalcashvalue = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_totalcashvalue.additional_properties = d
        return portfolio_summary_totalcashvalue
