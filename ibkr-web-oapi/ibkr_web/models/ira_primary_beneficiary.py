...
from ..models.ira_primary_beneficiary_gender import IRAPrimaryBeneficiaryGender
from ..models.ira_primary_beneficiary_marital_status import IRAPrimaryBeneficiaryMaritalStatus
from ..models.ira_primary_beneficiary_relationship import IRAPrimaryBeneficiaryRelationship
...
T = TypeVar("T", bound="IRAPrimaryBeneficiary")


@_attrs_define
class IRAPrimaryBeneficiary:
    r"""
    Attributes:
        ...
        gender (Union[Unset, IRAPrimaryBeneficiaryGender]):
        marital_status (Union[Unset, IRAPrimaryBeneficiaryMaritalStatus]):
        ...
        relationship (Union[Unset, IRAPrimaryBeneficiaryRelationship]):
    """
    ...
    gender: Union[Unset, IRAPrimaryBeneficiaryGender] = UNSET
    marital_status: Union[Unset, IRAPrimaryBeneficiaryMaritalStatus] = UNSET
    ...
    relationship: Union[Unset, IRAPrimaryBeneficiaryRelationship] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = IRAPrimaryBeneficiaryGender(_gender)
        ...
        if isinstance(_marital_status, Unset):
            ...
            marital_status = IRAPrimaryBeneficiaryMaritalStatus(_marital_status)
        ...
        if isinstance(_relationship, Unset):
            ...
            relationship = IRAPrimaryBeneficiaryRelationship(_relationship)

        ira_primary_beneficiary = cls(
            name=name,
        ...
        ira_primary_beneficiary.additional_properties = d
        return ira_primary_beneficiary
