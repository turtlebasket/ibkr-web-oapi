...
T = TypeVar("T", bound="PortfolioSummaryIndianstockhaircutC")


@_attrs_define
class PortfolioSummaryIndianstockhaircutC:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_indianstockhaircut_c = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_indianstockhaircut_c.additional_properties = d
        return portfolio_summary_indianstockhaircut_c
