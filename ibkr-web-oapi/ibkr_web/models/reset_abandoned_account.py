...
T = TypeVar("T", bound="ResetAbandonedAccount")


@_attrs_define
class ResetAbandonedAccount:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        reset_abandoned_account = cls(
            reference_account_id=reference_account_id,
        )

        reset_abandoned_account.additional_properties = d
        return reset_abandoned_account
