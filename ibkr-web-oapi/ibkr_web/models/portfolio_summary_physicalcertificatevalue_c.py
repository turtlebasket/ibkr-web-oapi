...
T = TypeVar("T", bound="PortfolioSummaryPhysicalcertificatevalueC")


@_attrs_define
class PortfolioSummaryPhysicalcertificatevalueC:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_physicalcertificatevalue_c = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_physicalcertificatevalue_c.additional_properties = d
        return portfolio_summary_physicalcertificatevalue_c
