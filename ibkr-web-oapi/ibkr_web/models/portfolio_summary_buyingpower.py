...
T = TypeVar("T", bound="PortfolioSummaryBuyingpower")


@_attrs_define
class PortfolioSummaryBuyingpower:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_buyingpower = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_buyingpower.additional_properties = d
        return portfolio_summary_buyingpower
