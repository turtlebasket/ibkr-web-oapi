...
T = TypeVar("T", bound="PortfolioSummaryPasharesvalueC")


@_attrs_define
class PortfolioSummaryPasharesvalueC:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_pasharesvalue_c = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_pasharesvalue_c.additional_properties = d
        return portfolio_summary_pasharesvalue_c
