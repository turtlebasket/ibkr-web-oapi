...
T = TypeVar("T", bound="PortfolioSummaryLookaheadinitmarginreq")


@_attrs_define
class PortfolioSummaryLookaheadinitmarginreq:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_lookaheadinitmarginreq = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_lookaheadinitmarginreq.additional_properties = d
        return portfolio_summary_lookaheadinitmarginreq
