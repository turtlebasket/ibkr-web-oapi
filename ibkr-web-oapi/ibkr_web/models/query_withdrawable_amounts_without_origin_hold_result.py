...
T = TypeVar("T", bound="QueryWithdrawableAmountsWithoutOriginHoldResult")


@_attrs_define
class QueryWithdrawableAmountsWithoutOriginHoldResult:
    """
    Attributes:
        ...
        account_id (str):
        currency (str):
        withdrawable_amount_without_origination_hold (float):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        withdrawable_amount_without_origination_hold = self.withdrawable_amount_without_origination_hold
        ...
        field_dict.update(
            {
                ...
                "currency": currency,
                "withdrawableAmountWithoutOriginationHold": withdrawable_amount_without_origination_hold,
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        withdrawable_amount_without_origination_hold = d.pop("withdrawableAmountWithoutOriginationHold")
        ...
        query_withdrawable_amounts_without_origin_hold_result = cls(
            ...
            currency=currency,
            withdrawable_amount_without_origination_hold=withdrawable_amount_without_origination_hold,
        ...
        query_withdrawable_amounts_without_origin_hold_result.additional_properties = d
        return query_withdrawable_amounts_without_origin_hold_result
