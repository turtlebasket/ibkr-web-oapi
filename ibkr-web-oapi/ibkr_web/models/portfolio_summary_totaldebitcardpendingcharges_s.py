...
T = TypeVar("T", bound="PortfolioSummaryTotaldebitcardpendingchargesS")


@_attrs_define
class PortfolioSummaryTotaldebitcardpendingchargesS:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_totaldebitcardpendingcharges_s = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_totaldebitcardpendingcharges_s.additional_properties = d
        return portfolio_summary_totaldebitcardpendingcharges_s
