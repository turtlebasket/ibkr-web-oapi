...
T = TypeVar("T", bound="PortfolioSummaryAccruedcashC")


@_attrs_define
class PortfolioSummaryAccruedcashC:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_accruedcash_c = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_accruedcash_c.additional_properties = d
        return portfolio_summary_accruedcash_c
