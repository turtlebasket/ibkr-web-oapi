...
T = TypeVar("T", bound="PortfolioSummaryAvailabletowithdrawC")


@_attrs_define
class PortfolioSummaryAvailabletowithdrawC:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_availabletowithdraw_c = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_availabletowithdraw_c.additional_properties = d
        return portfolio_summary_availabletowithdraw_c
