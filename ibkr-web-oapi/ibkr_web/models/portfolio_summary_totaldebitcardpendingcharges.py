...
T = TypeVar("T", bound="PortfolioSummaryTotaldebitcardpendingcharges")


@_attrs_define
class PortfolioSummaryTotaldebitcardpendingcharges:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_totaldebitcardpendingcharges = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_totaldebitcardpendingcharges.additional_properties = d
        return portfolio_summary_totaldebitcardpendingcharges
