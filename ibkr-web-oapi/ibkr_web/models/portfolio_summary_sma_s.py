...
T = TypeVar("T", bound="PortfolioSummarySmaS")


@_attrs_define
class PortfolioSummarySmaS:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_sma_s.additional_properties = d
        return portfolio_summary_sma_s
