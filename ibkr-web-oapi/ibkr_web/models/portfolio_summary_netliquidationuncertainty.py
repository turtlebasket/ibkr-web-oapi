...
T = TypeVar("T", bound="PortfolioSummaryNetliquidationuncertainty")


@_attrs_define
class PortfolioSummaryNetliquidationuncertainty:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_netliquidationuncertainty = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_netliquidationuncertainty.additional_properties = d
        return portfolio_summary_netliquidationuncertainty
