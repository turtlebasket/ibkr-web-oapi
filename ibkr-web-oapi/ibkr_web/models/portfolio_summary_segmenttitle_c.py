...
T = TypeVar("T", bound="PortfolioSummarySegmenttitleC")


@_attrs_define
class PortfolioSummarySegmenttitleC:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_segmenttitle_c = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_segmenttitle_c.additional_properties = d
        return portfolio_summary_segmenttitle_c
