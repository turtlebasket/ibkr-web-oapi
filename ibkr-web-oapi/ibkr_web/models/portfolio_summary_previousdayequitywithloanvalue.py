...
T = TypeVar("T", bound="PortfolioSummaryPreviousdayequitywithloanvalue")


@_attrs_define
class PortfolioSummaryPreviousdayequitywithloanvalue:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_previousdayequitywithloanvalue = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_previousdayequitywithloanvalue.additional_properties = d
        return portfolio_summary_previousdayequitywithloanvalue
