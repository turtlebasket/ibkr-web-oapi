...
T = TypeVar("T", bound="UserAccountsResponseServerInfo")


@_attrs_define
class UserAccountsResponseServerInfo:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        user_accounts_response_server_info = cls(
            server_name=server_name,
            server_version=server_version,
        )

        user_accounts_response_server_info.additional_properties = d
        return user_accounts_response_server_info
