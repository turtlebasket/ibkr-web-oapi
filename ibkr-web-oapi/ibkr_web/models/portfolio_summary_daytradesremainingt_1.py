...
T = TypeVar("T", bound="PortfolioSummaryDaytradesremainingt1")


@_attrs_define
class PortfolioSummaryDaytradesremainingt1:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_daytradesremainingt_1 = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_daytradesremainingt_1.additional_properties = d
        return portfolio_summary_daytradesremainingt_1
