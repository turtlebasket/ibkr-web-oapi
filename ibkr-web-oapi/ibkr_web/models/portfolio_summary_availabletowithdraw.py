...
T = TypeVar("T", bound="PortfolioSummaryAvailabletowithdraw")


@_attrs_define
class PortfolioSummaryAvailabletowithdraw:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_availabletowithdraw = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_availabletowithdraw.additional_properties = d
        return portfolio_summary_availabletowithdraw
