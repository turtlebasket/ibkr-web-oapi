...
T = TypeVar("T", bound="UpdateAccountAlias")


@_attrs_define
class UpdateAccountAlias:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_account_alias = cls(
            reference_account_id=reference_account_id,
            account_alias=account_alias,
        )

        update_account_alias.additional_properties = d
        return update_account_alias
