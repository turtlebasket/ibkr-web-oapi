...
T = TypeVar("T", bound="SummaryOfAccountMarginResponseTotal")


@_attrs_define
class SummaryOfAccountMarginResponseTotal:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        summary_of_account_margin_response_total = cls(
        ...
        summary_of_account_margin_response_total.additional_properties = d
        return summary_of_account_margin_response_total
