...
T = TypeVar("T", bound="PortfolioSummaryFullmaintmarginreq")


@_attrs_define
class PortfolioSummaryFullmaintmarginreq:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_fullmaintmarginreq = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_fullmaintmarginreq.additional_properties = d
        return portfolio_summary_fullmaintmarginreq
