...
T = TypeVar("T", bound="QueryWithdrawableAmountsWithoutOriginHoldResponse")


@_attrs_define
class QueryWithdrawableAmountsWithoutOriginHoldResponse:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        query_withdrawable_amounts_without_origin_hold_response = cls(
            status=status,
            instruction_set_id=instruction_set_id,
            instruction_result=instruction_result,
        )

        query_withdrawable_amounts_without_origin_hold_response.additional_properties = d
        return query_withdrawable_amounts_without_origin_hold_response
