...
T = TypeVar("T", bound="PortfolioSummaryRegtmargin")


@_attrs_define
class PortfolioSummaryRegtmargin:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_regtmargin = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_regtmargin.additional_properties = d
        return portfolio_summary_regtmargin
