...
T = TypeVar("T", bound="PortfolioSummaryDaytradesremainingt3")


@_attrs_define
class PortfolioSummaryDaytradesremainingt3:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_daytradesremainingt_3 = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_daytradesremainingt_3.additional_properties = d
        return portfolio_summary_daytradesremainingt_3
