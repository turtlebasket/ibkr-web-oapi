...
T = TypeVar("T", bound="EnableAccountInBrokerage")


@_attrs_define
class EnableAccountInBrokerage:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        enable_account_in_brokerage = cls(
            reference_account_id=reference_account_id,
        )

        enable_account_in_brokerage.additional_properties = d
        return enable_account_in_brokerage
