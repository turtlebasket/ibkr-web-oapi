...
T = TypeVar("T", bound="PortfolioSummaryPasharesvalue")


@_attrs_define
class PortfolioSummaryPasharesvalue:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_pasharesvalue = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_pasharesvalue.additional_properties = d
        return portfolio_summary_pasharesvalue
