...
from ..models.individual_gender import IndividualGender
from ..models.individual_marital_status import IndividualMaritalStatus
...
class Individual:
    ...
    Attributes:
        ...
        gender (Union[Unset, IndividualGender]):
        marital_status (Union[Unset, IndividualMaritalStatus]):
    ...
    gender: Union[Unset, IndividualGender] = UNSET
    marital_status: Union[Unset, IndividualMaritalStatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = IndividualGender(_gender)
        ...
        if isinstance(_marital_status, Unset):
            ...
            marital_status = IndividualMaritalStatus(_marital_status)
        ...
        individual.additional_properties = d
        return individual
