...
T = TypeVar("T", bound="PortfolioSummaryAvailablefunds")


@_attrs_define
class PortfolioSummaryAvailablefunds:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_availablefunds = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_availablefunds.additional_properties = d
        return portfolio_summary_availablefunds
