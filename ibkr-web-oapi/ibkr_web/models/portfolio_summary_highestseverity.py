...
T = TypeVar("T", bound="PortfolioSummaryHighestseverity")


@_attrs_define
class PortfolioSummaryHighestseverity:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_highestseverity = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_highestseverity.additional_properties = d
        return portfolio_summary_highestseverity
