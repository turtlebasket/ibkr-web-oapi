...
T = TypeVar("T", bound="PortfolioSummaryDepositoncredithold")


@_attrs_define
class PortfolioSummaryDepositoncredithold:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_depositoncredithold = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_depositoncredithold.additional_properties = d
        return portfolio_summary_depositoncredithold
