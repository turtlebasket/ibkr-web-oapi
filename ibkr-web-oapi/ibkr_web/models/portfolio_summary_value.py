...
T = TypeVar("T", bound="PortfolioSummaryValue")


@_attrs_define
class PortfolioSummaryValue:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_value.additional_properties = d
        return portfolio_summary_value
