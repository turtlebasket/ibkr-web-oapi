...
T = TypeVar("T", bound="PortfolioSummaryGrosspositionvalue")


@_attrs_define
class PortfolioSummaryGrosspositionvalue:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_grosspositionvalue = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_grosspositionvalue.additional_properties = d
        return portfolio_summary_grosspositionvalue
