...
T = TypeVar("T", bound="PortfolioSummaryIndianstockhaircut")


@_attrs_define
class PortfolioSummaryIndianstockhaircut:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_indianstockhaircut = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_indianstockhaircut.additional_properties = d
        return portfolio_summary_indianstockhaircut
