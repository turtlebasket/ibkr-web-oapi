...
from ..models.associated_individual_gender import AssociatedIndividualGender
from ..models.associated_individual_marital_status import AssociatedIndividualMaritalStatus
...
T = TypeVar("T", bound="AssociatedIndividual")


@_attrs_define
class AssociatedIndividual:
    r"""
    Attributes:
        ...
        gender (Union[Unset, AssociatedIndividualGender]):
        marital_status (Union[Unset, AssociatedIndividualMaritalStatus]):
        ...
        authorized_person (Union[Unset, bool]):
        reference_username (Union[Unset, str]):
    """
    ...
    gender: Union[Unset, AssociatedIndividualGender] = UNSET
    marital_status: Union[Unset, AssociatedIndividualMaritalStatus] = UNSET
    ...
    authorized_person: Union[Unset, bool] = UNSET
    reference_username: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if authorized_person is not UNSET:
            field_dict["authorizedPerson"] = authorized_person
        if reference_username is not UNSET:
            field_dict["referenceUsername"] = reference_username
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = AssociatedIndividualGender(_gender)
        ...
        if isinstance(_marital_status, Unset):
            ...
            marital_status = AssociatedIndividualMaritalStatus(_marital_status)
        ...
        authorized_person = d.pop("authorizedPerson", UNSET)

        reference_username = d.pop("referenceUsername", UNSET)

        associated_individual = cls(
            name=name,
        ...
        associated_individual.additional_properties = d
        return associated_individual
