...
T = TypeVar("T", bound="PortfolioSummaryAccountcode")


@_attrs_define
class PortfolioSummaryAccountcode:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_accountcode = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_accountcode.additional_properties = d
        return portfolio_summary_accountcode
