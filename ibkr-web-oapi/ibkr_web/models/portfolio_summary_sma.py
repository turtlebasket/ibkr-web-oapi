...
T = TypeVar("T", bound="PortfolioSummarySma")


@_attrs_define
class PortfolioSummarySma:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_sma.additional_properties = d
        return portfolio_summary_sma
