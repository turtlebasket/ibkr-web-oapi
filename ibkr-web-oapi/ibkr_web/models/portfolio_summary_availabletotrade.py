...
T = TypeVar("T", bound="PortfolioSummaryAvailabletotrade")


@_attrs_define
class PortfolioSummaryAvailabletotrade:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_availabletotrade = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_availabletotrade.additional_properties = d
        return portfolio_summary_availabletotrade
