...
T = TypeVar("T", bound="PortfolioSummaryDaytradesremainingt2")


@_attrs_define
class PortfolioSummaryDaytradesremainingt2:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_daytradesremainingt_2 = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_daytradesremainingt_2.additional_properties = d
        return portfolio_summary_daytradesremainingt_2
