...
T = TypeVar("T", bound="PortfolioSummaryFullavailablefunds")


@_attrs_define
class PortfolioSummaryFullavailablefunds:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_fullavailablefunds = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_fullavailablefunds.additional_properties = d
        return portfolio_summary_fullavailablefunds
