...
from ..models.ira_primary_beneficiary_entity_entity_type import IRAPrimaryBeneficiaryEntityEntityType
from ..models.ira_primary_beneficiary_entity_relationship import IRAPrimaryBeneficiaryEntityRelationship
...
T = TypeVar("T", bound="IRAPrimaryBeneficiaryEntity")


@_attrs_define
class IRAPrimaryBeneficiaryEntity:
    """
    Attributes:
        ...
        relationship (Union[Unset, IRAPrimaryBeneficiaryEntityRelationship]):
        executor (Union[Unset, Individual]):
        execution_date (Union[Unset, datetime.date]):
        article_of_will (Union[Unset, str]):
        entity_type (Union[Unset, IRAPrimaryBeneficiaryEntityEntityType]):
        charity_number (Union[Unset, str]):
    """
    ...
    relationship: Union[Unset, IRAPrimaryBeneficiaryEntityRelationship] = UNSET
    executor: Union[Unset, "Individual"] = UNSET
    execution_date: Union[Unset, datetime.date] = UNSET
    article_of_will: Union[Unset, str] = UNSET
    entity_type: Union[Unset, IRAPrimaryBeneficiaryEntityEntityType] = UNSET
    charity_number: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if charity_number is not UNSET:
            field_dict["charityNumber"] = charity_number
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_relationship, Unset):
            ...
            relationship = IRAPrimaryBeneficiaryEntityRelationship(_relationship)
        ...
        if isinstance(_entity_type, Unset):
            ...
            entity_type = IRAPrimaryBeneficiaryEntityEntityType(_entity_type)

        charity_number = d.pop("charityNumber", UNSET)

        ira_primary_beneficiary_entity = cls(
            name=name,
            address=address,
            id=id,
        ...
        ira_primary_beneficiary_entity.additional_properties = d
        return ira_primary_beneficiary_entity
