...
T = TypeVar("T", bound="PortfolioSummaryFullinitmarginreq")


@_attrs_define
class PortfolioSummaryFullinitmarginreq:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_fullinitmarginreq = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_fullinitmarginreq.additional_properties = d
        return portfolio_summary_fullinitmarginreq
