...
T = TypeVar("T", bound="PortfolioSummaryMaintmarginreq")


@_attrs_define
class PortfolioSummaryMaintmarginreq:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_maintmarginreq = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_maintmarginreq.additional_properties = d
        return portfolio_summary_maintmarginreq
