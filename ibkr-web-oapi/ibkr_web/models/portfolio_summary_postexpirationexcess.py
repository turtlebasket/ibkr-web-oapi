...
T = TypeVar("T", bound="PortfolioSummaryPostexpirationexcess")


@_attrs_define
class PortfolioSummaryPostexpirationexcess:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_postexpirationexcess = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_postexpirationexcess.additional_properties = d
        return portfolio_summary_postexpirationexcess
