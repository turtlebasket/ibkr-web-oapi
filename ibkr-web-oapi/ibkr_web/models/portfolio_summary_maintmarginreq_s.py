...
T = TypeVar("T", bound="PortfolioSummaryMaintmarginreqS")


@_attrs_define
class PortfolioSummaryMaintmarginreqS:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_maintmarginreq_s = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_maintmarginreq_s.additional_properties = d
        return portfolio_summary_maintmarginreq_s
