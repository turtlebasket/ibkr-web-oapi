...
T = TypeVar("T", bound="PortfolioSummaryLookaheadmaintmarginreq")


@_attrs_define
class PortfolioSummaryLookaheadmaintmarginreq:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_lookaheadmaintmarginreq = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_lookaheadmaintmarginreq.additional_properties = d
        return portfolio_summary_lookaheadmaintmarginreq
