...
T = TypeVar("T", bound="PortfolioSummaryTotaldebitcardpendingchargesC")


@_attrs_define
class PortfolioSummaryTotaldebitcardpendingchargesC:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_totaldebitcardpendingcharges_c = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_totaldebitcardpendingcharges_c.additional_properties = d
        return portfolio_summary_totaldebitcardpendingcharges_c
