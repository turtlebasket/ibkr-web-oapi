...
T = TypeVar("T", bound="PortfolioSummaryFullinitmarginreqC")


@_attrs_define
class PortfolioSummaryFullinitmarginreqC:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_fullinitmarginreq_c = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_fullinitmarginreq_c.additional_properties = d
        return portfolio_summary_fullinitmarginreq_c
