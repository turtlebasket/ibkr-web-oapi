...
T = TypeVar("T", bound="PortfolioSummaryRegtequity")


@_attrs_define
class PortfolioSummaryRegtequity:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_regtequity = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_regtequity.additional_properties = d
        return portfolio_summary_regtequity
