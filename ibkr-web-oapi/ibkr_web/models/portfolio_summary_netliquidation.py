...
T = TypeVar("T", bound="PortfolioSummaryNetliquidation")


@_attrs_define
class PortfolioSummaryNetliquidation:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_netliquidation = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_netliquidation.additional_properties = d
        return portfolio_summary_netliquidation
