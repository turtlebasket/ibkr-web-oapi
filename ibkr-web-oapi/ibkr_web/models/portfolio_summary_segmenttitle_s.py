...
T = TypeVar("T", bound="PortfolioSummarySegmenttitleS")


@_attrs_define
class PortfolioSummarySegmenttitleS:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_segmenttitle_s = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_segmenttitle_s.additional_properties = d
        return portfolio_summary_segmenttitle_s
