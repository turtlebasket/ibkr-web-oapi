...
T = TypeVar("T", bound="PortfolioSummaryGuarantee")


@_attrs_define
class PortfolioSummaryGuarantee:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_guarantee = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_guarantee.additional_properties = d
        return portfolio_summary_guarantee
