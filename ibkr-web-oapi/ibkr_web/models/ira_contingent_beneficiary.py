...
from ..models.ira_contingent_beneficiary_gender import IRAContingentBeneficiaryGender
from ..models.ira_contingent_beneficiary_marital_status import IRAContingentBeneficiaryMaritalStatus
from ..models.ira_contingent_beneficiary_relationship import IRAContingentBeneficiaryRelationship
...
T = TypeVar("T", bound="IRAContingentBeneficiary")


@_attrs_define
class IRAContingentBeneficiary:
    r"""
    Attributes:
        ...
        gender (Union[Unset, IRAContingentBeneficiaryGender]):
        marital_status (Union[Unset, IRAContingentBeneficiaryMaritalStatus]):
        ...
        relationship (Union[Unset, IRAContingentBeneficiaryRelationship]):
    """
    ...
    gender: Union[Unset, IRAContingentBeneficiaryGender] = UNSET
    marital_status: Union[Unset, IRAContingentBeneficiaryMaritalStatus] = UNSET
    ...
    relationship: Union[Unset, IRAContingentBeneficiaryRelationship] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = IRAContingentBeneficiaryGender(_gender)
        ...
        if isinstance(_marital_status, Unset):
            ...
            marital_status = IRAContingentBeneficiaryMaritalStatus(_marital_status)
        ...
        if isinstance(_relationship, Unset):
            ...
            relationship = IRAContingentBeneficiaryRelationship(_relationship)

        ira_contingent_beneficiary = cls(
            name=name,
        ...
        ira_contingent_beneficiary.additional_properties = d
        return ira_contingent_beneficiary
