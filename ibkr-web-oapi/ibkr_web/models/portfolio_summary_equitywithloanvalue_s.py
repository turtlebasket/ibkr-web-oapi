...
T = TypeVar("T", bound="PortfolioSummaryEquitywithloanvalueS")


@_attrs_define
class PortfolioSummaryEquitywithloanvalueS:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_equitywithloanvalue_s = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_equitywithloanvalue_s.additional_properties = d
        return portfolio_summary_equitywithloanvalue_s
