...
T = TypeVar("T", bound="PortfolioSummaryLookaheadexcessliquidity")


@_attrs_define
class PortfolioSummaryLookaheadexcessliquidity:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_lookaheadexcessliquidity = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_lookaheadexcessliquidity.additional_properties = d
        return portfolio_summary_lookaheadexcessliquidity
