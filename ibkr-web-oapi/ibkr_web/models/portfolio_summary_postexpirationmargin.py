...
T = TypeVar("T", bound="PortfolioSummaryPostexpirationmargin")


@_attrs_define
class PortfolioSummaryPostexpirationmargin:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_postexpirationmargin = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_postexpirationmargin.additional_properties = d
        return portfolio_summary_postexpirationmargin
