...
T = TypeVar("T", bound="PortfolioSummaryPhysicalcertificatevalue")


@_attrs_define
class PortfolioSummaryPhysicalcertificatevalue:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_physicalcertificatevalue = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_physicalcertificatevalue.additional_properties = d
        return portfolio_summary_physicalcertificatevalue
