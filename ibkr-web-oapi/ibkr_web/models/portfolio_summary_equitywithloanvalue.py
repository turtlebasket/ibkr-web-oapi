...
T = TypeVar("T", bound="PortfolioSummaryEquitywithloanvalue")


@_attrs_define
class PortfolioSummaryEquitywithloanvalue:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_equitywithloanvalue = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_equitywithloanvalue.additional_properties = d
        return portfolio_summary_equitywithloanvalue
