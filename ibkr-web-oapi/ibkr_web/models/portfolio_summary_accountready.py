...
T = TypeVar("T", bound="PortfolioSummaryAccountready")


@_attrs_define
class PortfolioSummaryAccountready:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_accountready = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_accountready.additional_properties = d
        return portfolio_summary_accountready
