...
T = TypeVar("T", bound="PortfolioSummaryExcessliquidity")


@_attrs_define
class PortfolioSummaryExcessliquidity:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_excessliquidity = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_excessliquidity.additional_properties = d
        return portfolio_summary_excessliquidity
