...
T = TypeVar("T", bound="AlertDeletionResponse")


@_attrs_define
class AlertDeletionResponse:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        alert_deletion_response.additional_properties = d
        return alert_deletion_response
