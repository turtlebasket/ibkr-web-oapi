...
T = TypeVar("T", bound="PortfolioSummaryLookaheadavailablefunds")


@_attrs_define
class PortfolioSummaryLookaheadavailablefunds:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_lookaheadavailablefunds = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_lookaheadavailablefunds.additional_properties = d
        return portfolio_summary_lookaheadavailablefunds
