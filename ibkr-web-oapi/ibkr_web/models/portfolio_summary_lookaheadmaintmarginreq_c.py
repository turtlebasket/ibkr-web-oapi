...
T = TypeVar("T", bound="PortfolioSummaryLookaheadmaintmarginreqC")


@_attrs_define
class PortfolioSummaryLookaheadmaintmarginreqC:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_lookaheadmaintmarginreq_c = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_lookaheadmaintmarginreq_c.additional_properties = d
        return portfolio_summary_lookaheadmaintmarginreq_c
