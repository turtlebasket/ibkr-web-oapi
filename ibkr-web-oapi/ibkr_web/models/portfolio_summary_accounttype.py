...
T = TypeVar("T", bound="PortfolioSummaryAccounttype")


@_attrs_define
class PortfolioSummaryAccounttype:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_accounttype = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_accounttype.additional_properties = d
        return portfolio_summary_accounttype
