...
T = TypeVar("T", bound="PortfolioSummaryPostexpirationexcessS")


@_attrs_define
class PortfolioSummaryPostexpirationexcessS:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_postexpirationexcess_s = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_postexpirationexcess_s.additional_properties = d
        return portfolio_summary_postexpirationexcess_s
