...
T = TypeVar("T", bound="PortfolioSummaryDaytradesremaining")


@_attrs_define
class PortfolioSummaryDaytradesremaining:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_daytradesremaining = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_daytradesremaining.additional_properties = d
        return portfolio_summary_daytradesremaining
