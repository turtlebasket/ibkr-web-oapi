...
T = TypeVar("T", bound="DisableAccountInBrokerage")


@_attrs_define
class DisableAccountInBrokerage:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        disable_account_in_brokerage = cls(
            reference_account_id=reference_account_id,
        )

        disable_account_in_brokerage.additional_properties = d
        return disable_account_in_brokerage
