...
T = TypeVar("T", bound="PollingInstructionResult")


@_attrs_define
class PollingInstructionResult:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        polling_instruction_result = cls(
        ...
        polling_instruction_result.additional_properties = d
        return polling_instruction_result
