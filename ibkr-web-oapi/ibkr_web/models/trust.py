...
class Trust:
    """
    Attributes:
        identification (Union[Unset, TrustIdentification]):
        regulatory_information (Union[Unset, RegulatoryInformation]):
    """

    identification: Union[Unset, "TrustIdentification"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_identification, Unset):
            ...
            identification = TrustIdentification.from_dict(_identification)
