...
T = TypeVar("T", bound="PortfolioSummaryColumnprioC")


@_attrs_define
class PortfolioSummaryColumnprioC:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_columnprio_c = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_columnprio_c.additional_properties = d
        return portfolio_summary_columnprio_c
