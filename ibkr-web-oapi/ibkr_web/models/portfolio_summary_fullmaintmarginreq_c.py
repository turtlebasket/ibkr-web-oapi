...
T = TypeVar("T", bound="PortfolioSummaryFullmaintmarginreqC")


@_attrs_define
class PortfolioSummaryFullmaintmarginreqC:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_fullmaintmarginreq_c = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_fullmaintmarginreq_c.additional_properties = d
        return portfolio_summary_fullmaintmarginreq_c
