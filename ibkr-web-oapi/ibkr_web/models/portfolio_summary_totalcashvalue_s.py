...
T = TypeVar("T", bound="PortfolioSummaryTotalcashvalueS")


@_attrs_define
class PortfolioSummaryTotalcashvalueS:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_totalcashvalue_s = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_totalcashvalue_s.additional_properties = d
        return portfolio_summary_totalcashvalue_s
