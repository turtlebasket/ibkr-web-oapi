...
T = TypeVar("T", bound="PortfolioSummaryInitmarginreq")


@_attrs_define
class PortfolioSummaryInitmarginreq:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_initmarginreq = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_initmarginreq.additional_properties = d
        return portfolio_summary_initmarginreq
