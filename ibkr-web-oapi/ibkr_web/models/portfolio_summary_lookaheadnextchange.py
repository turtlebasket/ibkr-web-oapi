...
T = TypeVar("T", bound="PortfolioSummaryLookaheadnextchange")


@_attrs_define
class PortfolioSummaryLookaheadnextchange:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_lookaheadnextchange = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_lookaheadnextchange.additional_properties = d
        return portfolio_summary_lookaheadnextchange
