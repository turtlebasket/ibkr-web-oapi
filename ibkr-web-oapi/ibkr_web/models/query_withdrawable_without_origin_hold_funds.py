...
T = TypeVar("T", bound="QueryWithdrawableWithoutOriginHoldFunds")


@_attrs_define
class QueryWithdrawableWithoutOriginHoldFunds:
    """
    Attributes:
        bank_routing_number (str):  Example: 122199983.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        query_withdrawable_without_origin_hold_funds = cls(
            bank_routing_number=bank_routing_number,
            bank_client_account_number=bank_client_account_number,
        )

        query_withdrawable_without_origin_hold_funds.additional_properties = d
        return query_withdrawable_without_origin_hold_funds
