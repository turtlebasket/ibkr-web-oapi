...
from ..models.process_documents_input_language import ProcessDocumentsInputLanguage
...
T = TypeVar("T", bound="ProcessDocuments")
...
class ProcessDocuments:
    ...
    Attributes:
        ...
        input_language (Union[Unset, ProcessDocumentsInputLanguage]):
        translation (Union[Unset, bool]):
    """

    documents: Union[Unset, List["Document"]] = UNSET
    input_language: Union[Unset, ProcessDocumentsInputLanguage] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_input_language, Unset):
            ...
            input_language = ProcessDocumentsInputLanguage(_input_language)

        translation = d.pop("translation", UNSET)

        process_documents = cls(
            documents=documents,
            input_language=input_language,
            translation=translation,
        )

        process_documents.additional_properties = d
