...
T = TypeVar("T", bound="PortfolioSummaryEquitywithloanvalueC")


@_attrs_define
class PortfolioSummaryEquitywithloanvalueC:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_equitywithloanvalue_c = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_equitywithloanvalue_c.additional_properties = d
        return portfolio_summary_equitywithloanvalue_c
