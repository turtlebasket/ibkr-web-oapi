...
T = TypeVar("T", bound="PortfolioSummaryRegtmarginS")


@_attrs_define
class PortfolioSummaryRegtmarginS:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_regtmargin_s = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_regtmargin_s.additional_properties = d
        return portfolio_summary_regtmargin_s
