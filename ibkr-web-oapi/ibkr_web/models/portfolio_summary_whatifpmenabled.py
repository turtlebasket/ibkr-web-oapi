...
T = TypeVar("T", bound="PortfolioSummaryWhatifpmenabled")


@_attrs_define
class PortfolioSummaryWhatifpmenabled:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_summary_whatifpmenabled = cls(
            amount=amount,
            currency=currency,
            is_null=is_null,
            severity=severity,
        ...
        portfolio_summary_whatifpmenabled.additional_properties = d
        return portfolio_summary_whatifpmenabled
