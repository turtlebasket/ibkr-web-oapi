...
T = TypeVar("T", bound="SummaryOfAccountMarginResponseSecurities")


@_attrs_define
class SummaryOfAccountMarginResponseSecurities:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        summary_of_account_margin_response_securities = cls(
        ...
        summary_of_account_margin_response_securities.additional_properties = d
        return summary_of_account_margin_response_securities
