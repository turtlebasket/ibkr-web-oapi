...
T = TypeVar("T", bound="InstructionPollingResponse")


@_attrs_define
class InstructionPollingResponse:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        instruction_polling_response = cls(
            status=status,
            instruction_set_id=instruction_set_id,
            instruction_result=instruction_result,
        )

        instruction_polling_response.additional_properties = d
        return instruction_polling_response
