...
from ..models.ira_decedent_gender import IRADecedentGender
from ..models.ira_decedent_inheritor_type import IRADecedentInheritorType
from ..models.ira_decedent_marital_status import IRADecedentMaritalStatus
from ..models.ira_decedent_relationship import IRADecedentRelationship
...
class IRADecedent:
    ...
    Attributes:
        ...
        gender (Union[Unset, IRADecedentGender]):
        marital_status (Union[Unset, IRADecedentMaritalStatus]):
        ...
        inheritor_type (Union[Unset, IRADecedentInheritorType]):
        relationship (Union[Unset, IRADecedentRelationship]):
    """
    ...
    gender: Union[Unset, IRADecedentGender] = UNSET
    marital_status: Union[Unset, IRADecedentMaritalStatus] = UNSET
    ...
    inheritor_type: Union[Unset, IRADecedentInheritorType] = UNSET
    relationship: Union[Unset, IRADecedentRelationship] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        inheritor_type: Union[Unset, str] = UNSET
        if not isinstance(self.inheritor_type, Unset):
            inheritor_type = self.inheritor_type.value
        ...
        if inheritor_type is not UNSET:
            field_dict["inheritorType"] = inheritor_type
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = IRADecedentGender(_gender)
        ...
        if isinstance(_marital_status, Unset):
            ...
            marital_status = IRADecedentMaritalStatus(_marital_status)
        ...
        _date_of_death = d.pop("dateOfDeath", UNSET)
        date_of_death: Union[Unset, datetime.date]
        ...
        _inheritor_type = d.pop("inheritorType", UNSET)
        inheritor_type: Union[Unset, IRADecedentInheritorType]
        if isinstance(_inheritor_type, Unset):
            inheritor_type = UNSET
        else:
            inheritor_type = IRADecedentInheritorType(_inheritor_type)
        ...
        if isinstance(_relationship, Unset):
            ...
            relationship = IRADecedentRelationship(_relationship)
        ...
        ira_decedent.additional_properties = d
        return ira_decedent
