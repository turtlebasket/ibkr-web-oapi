...
from ...models.login_message_request import LoginMessageRequest
...
def _get_kwargs(
    *,
    login_message_request: "LoginMessageRequest",
) -> Dict[str, Any]:
    params: Dict[str, Any] = {}

    json_login_message_request = login_message_request.to_dict()
    params.update(json_login_message_request)

    params = {k: v for k, v in params.items() if v is not UNSET and v is not None}

    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/gw/api/v1/accounts/login-messages",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    """Get Login Messages
     ...
     Query all accounts associated with ‘Client ID’ that have incomplete login message<br><br>**Scope**:
    ...
    kwargs = _get_kwargs(
        login_message_request=login_message_request,
    )
